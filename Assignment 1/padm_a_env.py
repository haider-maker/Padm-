...
# understand what a class is and what a constructor is, what self is.

class PadmACustomEnv(gym.Env): #custom env (class) in which we define diff func
    def __init__(self, grid_size=5): #1st func by default when using a class to code intialising func
    ...
    def step(self, action): #action is the up,down,lft,rgt
    ...
    def close(self): #didn't press the cross manually cz we too coooooollll
        plt.close()
